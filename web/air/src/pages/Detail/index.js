...
const Detail = (props) => {
    ...
    const spec_pie = {
        ...
        title: {
            visible: true,
            text: 'Model Call Frequency Distribution'
        },
        legends: {
            visible: true,
            orient: 'left'
    ...
    const updateChart = (lineChart, pieChart, data) => {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            // Merge created_at and model_name into lineData, created_at data type is hourly timestamp
            // Convert date format
                        ...
                        <>
                            ...
                            <Form.Section>
                                <Button label='Query' type="primary" htmlType="submit" className="btn-margin-right"
                                        onClick={refresh} loading={loading}>Query</Button>
                            </Form.Section>
                        </>
                    </Form>
