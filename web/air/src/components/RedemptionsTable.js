    ...
    <>
      ...
      <Form onSubmit={searchRedemptions}>
        <Form.Input
          ...
          icon="search"
          iconPosition="left"
          placeholder="Keywords (ID or Name)"
          value={searchKeyword}
          loading={searching}
      ...
      <Table style={{ marginTop: 20 }} columns={columns} dataSource={pageData} pagination={{
        ...
        formatPageText: (page) => `${page.currentStart} - ${page.currentEnd} of ${redemptions.length} items`,
      ...
      <Button label="Copy Selected Redemption Codes" type="warning" onClick={
        async () => {
      ...
      }>Copy Selected Redemption Codes to Clipboard</Button>
    </>
  );
};
