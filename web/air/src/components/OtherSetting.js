    ...
    <Grid columns={1}>
      <Grid.Column>
        <Form loading={loading}>
          ...
          <Form.Button onClick={checkUpdate}>Check Updates</Form.Button>
          ...
          <Form.Group widths='equal'>
            <Form.TextArea
              ...
              placeholder='Enter homepage content here, supports Markdown & HTML code. After setting, the status information on the homepage will no longer be displayed. If a link is entered, it will be used as the src attribute of an iframe, allowing you to set any webpage as the homepage.'
          ...
          <Form.Group widths='equal'>
            <Form.TextArea
              label='About'
              placeholder='Enter new about content here, supports Markdown & HTML code. If a link is entered, it will be used as the src attribute of an iframe, allowing you to set any webpage as the about page.'
              value={inputs.About}
              name='About'
              onChange={handleInputChange}
              style={{ minHeight: 150, fontFamily: 'JetBrains Mono, Consolas' }}
          ...
          <Form.Group widths='equal'>
            <Form.Input
              label='Footer'
              placeholder='Enter new footer here, leave blank to use default footer, supports HTML code'
              value={inputs.Footer}
              name='Footer'
              onChange={handleInputChange}
            />
