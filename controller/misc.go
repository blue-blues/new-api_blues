...
func SendEmailVerification(c *gin.Context) {
	...
	content := message.EmailTemplate(
		...
		fmt.Sprintf(`
			<p>Hello!</p>
			<p>You are performing email verification for %s.</p>
			...
			<p style="color: #666;">The verification code is valid for %d minutes. If this is not your operation, please ignore.</p>
...
func SendPasswordResetEmail(c *gin.Context) {
	...
	content := message.EmailTemplate(
		...
		fmt.Sprintf(`
			<p>Hello!</p>
			<p>You are performing password reset for %s.</p>
			...
			<p style="color: #666;">If the button cannot be clicked, please copy the following link to your browser:</p>
			<p style="background-color: #f8f8f8; padding: 10px; border-radius: 4px; word-break: break-all;">%s</p>
			<p style="color: #666;">The reset link is valid for %d minutes. If this is not your operation, please ignore.</p>
