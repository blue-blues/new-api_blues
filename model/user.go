...
func (user *User) Insert(ctx context.Context, inviterId int) error {
	...
	if inviterId != 0 {
		...
		if config.QuotaForInviter > 0 {
			...
			RecordLog(ctx, inviterId, LogTypeSystem, fmt.Sprintf("User invitation bonus %s", common.LogQuota(config.QuotaForInviter)))
		}
	}
...
func (user *User) ValidateAndFill() (err error) {
	...
	if err != nil {
		...
		if err != nil {
			return errors.New("Incorrect username or password, or user has been banned")
		}
	}
